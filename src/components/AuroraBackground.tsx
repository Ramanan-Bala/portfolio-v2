...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "transition-bg relative flex flex-col items-center justify-center bg-gradient-to-b from-slate-300 via-slate-100 to-transparent dark:from-tertiary dark:via-tertiary",
          className,
        )}
        {...props}
      >
