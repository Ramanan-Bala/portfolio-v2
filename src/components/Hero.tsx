          ...
          <div className="flex flex-col justify-between gap-[100px] lg:flex-row lg:items-end lg:gap-[120px]">
            <div className="flex flex-col gap-[50px] lg:gap-[120px]">
              ...
              >
                ...
                <div className="flex">
                  <WavyText text="Balamurugan" delay={1.35} />
              ...
              <motion.div
                ...
                animate={{ opacity: 1 }}
                transition={{ delay: 1 }}
                className="hero-social flex gap-x-[50px] md:gap-x-[80px]"
              >
                <div className="animation-delay-1000 animate-slidebottom">
                  <MagneticEffect>
                    <a href="">
                      <svg
                ...
                <div className="animation-delay-1000 animate-slidebottomT2">
                  <MagneticEffect>
                    <a href="">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="animation-delay-1000 animate-slidebottomT4">
                  <MagneticEffect>
                    <a href="">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
